...
id: "mailbox-inbox-2026-05-07-114148-feedback-pressure-challenge"
type: "mailbox-inbox"
status: "done"
owner: "supervisor"
created: "2026-05-07"
...
message_id: "2026-05-07-114148-feedback-pressure-challenge"
tags:
  - supervisor
  - feedback-pressure
  - explicit-feedback
...
> Human feedback: the trigger list now works, but the latest run still proved a separate stop-too-easily failure: the agent can spend minutes on broad discovery before claiming the single pending inbox, and only after a watchdog incident did it claim. Raise the bar by making claim latency operational and checkable. Create one focused mechanism or bounded refusal so a future supervisor can detect pending-inbox launches where the session performs broad queries before the first mailbox claim. The mechanism should use existing session/mailbox evidence, avoid broad repository sweeps, and prove at least one delayed-claim negative case and one claim-first/pass case.
