...
id: "mailbox-inbox-2026-05-08-022223-trigger-review-pressure-challenge"
type: "mailbox-inbox"
status: "done"
owner: "supervisor"
created: "2026-05-08"
...
message_id: "2026-05-08-022223-trigger-review-pressure-challenge"
tags:
  - supervisor
  - feedback-pressure
  - trigger-review
...
trigger-review-source: "mailbox/outbox/2026-05-08-status-sync-v3-proof-reply.md"
---
...
1. Review `mailbox/outbox/2026-05-08-status-sync-v3-proof-reply.md` and run `scripts/supervisor.sh triggers --status review --limit 8` before choosing a response.
