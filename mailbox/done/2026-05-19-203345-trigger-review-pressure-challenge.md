...
id: "mailbox-inbox-2026-05-19-203345-trigger-review-pressure-challenge"
type: "mailbox-inbox"
status: "done"
owner: "supervisor"
created: "2026-05-19"
...
message_id: "2026-05-19-203345-trigger-review-pressure-challenge"
tags:
  - supervisor
  - feedback-pressure
  - trigger-review
...
1. Review `mailbox/outbox/2026-05-20-post-run-pressure-skill-adoption-reply.md` and run `scripts/supervisor.sh triggers --status review --limit 8` before choosing a response.
